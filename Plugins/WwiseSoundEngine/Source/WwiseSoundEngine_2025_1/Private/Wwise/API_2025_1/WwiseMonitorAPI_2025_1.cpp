...
AKRESULT FWwiseMonitorAPI_2025_1::PostCode(
...
AKRESULT FWwiseMonitorAPI_2025_1::PostCodeVarArg(
	AK::Monitor::ErrorCode in_eError,
	AK::Monitor::ErrorLevel in_eErrorLevel,
...
AKRESULT FWwiseMonitorAPI_2025_1::PostCodeVaList(
	AK::Monitor::ErrorCode in_eError,
	AK::Monitor::ErrorLevel in_eErrorLevel,
	AK::Monitor::MsgContext msgContext,
	::va_list args
...
AKRESULT FWwiseMonitorAPI_2025_1::PostString(
...
AKRESULT FWwiseMonitorAPI_2025_1::SetLocalOutput(
...
AKRESULT FWwiseMonitorAPI_2025_1::AddTranslator(
...
AKRESULT FWwiseMonitorAPI_2025_1::ResetTranslator(
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AkTimeMs FWwiseMonitorAPI_2025_1::GetTimeStamp()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::Monitor::GetTimeStamp();
}

void FWwiseMonitorAPI_2025_1::MonitorStreamMgrInit(
...
void FWwiseMonitorAPI_2025_1::MonitorStreamingDeviceInit(
...
void FWwiseMonitorAPI_2025_1::MonitorStreamingDeviceDestroyed(
	AkDeviceID in_deviceID
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
void FWwiseMonitorAPI_2025_1::MonitorStreamMgrTerm()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
