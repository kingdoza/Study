...
class FWwisePlatformAPI_2025_1_Android : public IWwisePlatformAPI
{
public:
	UE_NONCOPYABLE(FWwisePlatformAPI_2025_1_Android);
	FWwisePlatformAPI_2025_1_Android() = default;
	virtual ~FWwisePlatformAPI_2025_1_Android() override {}
...
using FWwisePlatformAPI = FWwisePlatformAPI_2025_1_Android;
