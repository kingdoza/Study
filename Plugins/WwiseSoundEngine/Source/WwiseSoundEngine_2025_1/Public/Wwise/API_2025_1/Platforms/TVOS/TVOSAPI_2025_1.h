...
class FWwisePlatformAPI_2025_1_TVOS : public IWwisePlatformAPI
{
public:
	UE_NONCOPYABLE(FWwisePlatformAPI_2025_1_TVOS);
	FWwisePlatformAPI_2025_1_TVOS() = default;
	virtual ~FWwisePlatformAPI_2025_1_TVOS() override {}
...
using FWwisePlatformAPI = FWwisePlatformAPI_2025_1_TVOS;
