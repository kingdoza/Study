...
AKRESULT FWwiseMemoryMgrAPI_2025_1::Init(
...
void FWwiseMemoryMgrAPI_2025_1::GetDefaultSettings(
...
bool FWwiseMemoryMgrAPI_2025_1::IsInitialized()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::MemoryMgr::IsInitialized();
}

void FWwiseMemoryMgrAPI_2025_1::Term()
{
...
void FWwiseMemoryMgrAPI_2025_1::InitForThread()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	AK::MemoryMgr::InitForThread();
}

void FWwiseMemoryMgrAPI_2025_1::TermForThread()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	AK::MemoryMgr::TermForThread();
}

void FWwiseMemoryMgrAPI_2025_1::TrimForThread()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	AK::MemoryMgr::TrimForThread();
}

void* FWwiseMemoryMgrAPI_2025_1::dMalloc(
...
void* FWwiseMemoryMgrAPI_2025_1::Malloc(
	AkMemPoolId in_poolId,
	size_t		in_uSize
)
{
...
void* FWwiseMemoryMgrAPI_2025_1::dRealloc(
	AkMemPoolId	in_poolId,
	void* in_pAlloc,
	size_t		in_uSize,
	const char* in_pszFile,
...
void* FWwiseMemoryMgrAPI_2025_1::Realloc(
	AkMemPoolId in_poolId,
	void* in_pAlloc,
	size_t		in_uSize
)
...
void* FWwiseMemoryMgrAPI_2025_1::dReallocAligned(
	AkMemPoolId	in_poolId,
	void* in_pAlloc,
	size_t		in_uSize,
...
void* FWwiseMemoryMgrAPI_2025_1::ReallocAligned(
	AkMemPoolId in_poolId,
	void* in_pAlloc,
	size_t		in_uSize,
	AkUInt32	in_uAlignment
...
void FWwiseMemoryMgrAPI_2025_1::Free(
	AkMemPoolId in_poolId,
	void* in_pMemAddress
)
{
...
void* FWwiseMemoryMgrAPI_2025_1::dMalign(
	AkMemPoolId in_poolId,
	size_t		in_uSize,
	AkUInt32	in_uAlignment,
	const char* in_pszFile,
...
void* FWwiseMemoryMgrAPI_2025_1::Malign(
	AkMemPoolId in_poolId,
	size_t		in_uSize,
	AkUInt32	in_uAlignment
)
...
void FWwiseMemoryMgrAPI_2025_1::GetCategoryStats(
	AkMemPoolId	in_poolId,
...
void FWwiseMemoryMgrAPI_2025_1::GetGlobalStats(
...
void FWwiseMemoryMgrAPI_2025_1::StartProfileThreadUsage(
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AkUInt64 FWwiseMemoryMgrAPI_2025_1::StopProfileThreadUsage(
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
void FWwiseMemoryMgrAPI_2025_1::DumpToFile(
