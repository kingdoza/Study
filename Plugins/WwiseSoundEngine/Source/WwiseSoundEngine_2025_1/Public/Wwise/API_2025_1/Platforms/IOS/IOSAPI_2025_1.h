...
#include "Wwise/API_2025_1/Platforms/TVOS/TVOSAPI_2025_1.h"
#elif defined(PLATFORM_IOS) && PLATFORM_IOS

class FWwisePlatformAPI_2025_1_IOS : public IWwisePlatformAPI
{
public:
	UE_NONCOPYABLE(FWwisePlatformAPI_2025_1_IOS);
	FWwisePlatformAPI_2025_1_IOS() = default;
	virtual ~FWwisePlatformAPI_2025_1_IOS() override {}
...
using FWwisePlatformAPI = FWwisePlatformAPI_2025_1_IOS;
