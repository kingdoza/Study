...
AK::IAkStreamMgr* FWwiseStreamMgrAPI_2025_1::GetAkStreamMgrInstance()
{
	IWwiseSoundEngineModule::ForceLoadModule();
	return AK::IAkStreamMgr::Get();
}

AK::IAkStreamMgr* FWwiseStreamMgrAPI_2025_1::Create(
...
void FWwiseStreamMgrAPI_2025_1::GetDefaultSettings(
...
AK::StreamMgr::IAkFileLocationResolver* FWwiseStreamMgrAPI_2025_1::GetFileLocationResolver()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::StreamMgr::GetFileLocationResolver();
}

void FWwiseStreamMgrAPI_2025_1::SetFileLocationResolver(
...
AKRESULT FWwiseStreamMgrAPI_2025_1::CreateDevice(
...
AKRESULT FWwiseStreamMgrAPI_2025_1::DestroyDevice(
...
AKRESULT FWwiseStreamMgrAPI_2025_1::PerformIO()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::StreamMgr::PerformIO();
}

void FWwiseStreamMgrAPI_2025_1::GetDefaultDeviceSettings(
...
AKRESULT FWwiseStreamMgrAPI_2025_1::SetCurrentLanguage(
...
const AkOSChar* FWwiseStreamMgrAPI_2025_1::GetCurrentLanguage()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::StreamMgr::GetCurrentLanguage();
}

AKRESULT FWwiseStreamMgrAPI_2025_1::AddLanguageChangeObserver(
...
void FWwiseStreamMgrAPI_2025_1::RemoveLanguageChangeObserver(
	void* in_pCookie
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
void FWwiseStreamMgrAPI_2025_1::FlushAllCaches()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
