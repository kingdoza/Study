...
class WWISESOUNDENGINE_API FWwiseMemoryMgrAPI_2025_1 : public IWwiseMemoryMgrAPI
{
public:
	UE_NONCOPYABLE(FWwiseMemoryMgrAPI_2025_1);
	FWwiseMemoryMgrAPI_2025_1() = default;
