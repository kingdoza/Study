...
class WWISESOUNDENGINE_API FWwiseStreamMgrAPI_2025_1 : public IWwiseStreamMgrAPI
{
public:
	UE_NONCOPYABLE(FWwiseStreamMgrAPI_2025_1);
	FWwiseStreamMgrAPI_2025_1() = default;
