...
class FWwisePlatformAPI_2025_1_Windows : public IWwisePlatformAPI
{
public:
	UE_NONCOPYABLE(FWwisePlatformAPI_2025_1_Windows);
	FWwisePlatformAPI_2025_1_Windows() = default;
	virtual ~FWwisePlatformAPI_2025_1_Windows() override {}
...
using FWwisePlatformAPI = FWwisePlatformAPI_2025_1_Windows;
