...
#include "Wwise/API_2025_1/Platforms/IOS/IOSAPI_2025_1.h"
...
void FWwisePlatformAPI_2025_1_IOS::ChangeAudioSessionProperties(
...
AkDeviceID FWwisePlatformAPI_2025_1_IOS::GetDeviceIDFromPlayerIndex(int playerIndex)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
