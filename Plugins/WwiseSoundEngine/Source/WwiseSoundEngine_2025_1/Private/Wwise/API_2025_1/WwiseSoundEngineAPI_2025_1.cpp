...
void FWwiseSoundEngineAPI_2025_1::GetDefaultInitSettings(
...
void FWwiseSoundEngineAPI_2025_1::GetDefaultPlatformInitSettings(
...
void FWwiseSoundEngineAPI_2025_1::Term()
{
...
AKRESULT FWwiseSoundEngineAPI_2025_1::GetAudioSettings(
...
AkChannelConfig FWwiseSoundEngineAPI_2025_1::GetSpeakerConfiguration(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::GetOutputDeviceConfiguration(
	AkOutputDeviceID in_idOutput,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::GetPanningRule(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetPanningRule(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::GetSpeakerAngles(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetSpeakerAngles(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetVolumeThreshold(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetMaxNumVoicesLimit(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetJobMgrMaxActiveWorkers( 
...
AKRESULT FWwiseSoundEngineAPI_2025_1::RenderAudio(
...
AK::IAkGlobalPluginContext* FWwiseSoundEngineAPI_2025_1::GetGlobalPluginContext()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::SoundEngine::GetGlobalPluginContext();
}

AKRESULT FWwiseSoundEngineAPI_2025_1::RegisterPlugin(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::RegisterPluginDLL(
...
bool FWwiseSoundEngineAPI_2025_1::IsPluginRegistered(
	AkPluginType in_eType,
	AkUInt32 in_ulCompanyID,
	AkUInt32 in_ulPluginID
	)
...
AKRESULT FWwiseSoundEngineAPI_2025_1::RegisterCodec(
	AkUInt32 in_ulCompanyID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::RegisterGlobalCallback(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::UnregisterGlobalCallback(
	AkGlobalCallbackFunc in_pCallback,
	AkUInt32 in_eLocation
)
{
...
AKRESULT FWwiseSoundEngineAPI_2025_1::RegisterResourceMonitorCallback(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::UnregisterResourceMonitorCallback(
	AkResourceMonitorCallbackFunc in_pCallback
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2025_1::RegisterAudioDeviceStatusCallback(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::UnregisterAudioDeviceStatusCallback()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AkUInt32 FWwiseSoundEngineAPI_2025_1::GetIDFromString(const wchar_t* in_pszString)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AkUInt32 FWwiseSoundEngineAPI_2025_1::GetIDFromString(const char* in_pszString)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::SoundEngine::GetIDFromString(in_pszString);
}

AkPlayingID FWwiseSoundEngineAPI_2025_1::PostEvent(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::ExecuteActionOnEvent(
	AkUniqueID in_eventID,
...
AkPlayingID FWwiseSoundEngineAPI_2025_1::PostMIDIOnEvent(
	AkUniqueID in_eventID,
	AkGameObjectID in_gameObjectID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::StopMIDIOnEvent(
	AkUniqueID in_eventID,
	AkGameObjectID in_gameObjectID,
	AkPlayingID in_playingID
)
...
AKRESULT FWwiseSoundEngineAPI_2025_1::PinEventInStreamCache(
	AkUniqueID in_eventID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::UnpinEventInStreamCache(
	AkUniqueID in_eventID
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2025_1::GetBufferStatusForPinnedEvent(
	AkUniqueID in_eventID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SeekOnEvent(
	AkUniqueID in_eventID,
	AkGameObjectID in_gameObjectID,
...
void FWwiseSoundEngineAPI_2025_1::CancelEventCallbackCookie(
	void* in_pCookie
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
void FWwiseSoundEngineAPI_2025_1::CancelEventCallbackGameObject(
	AkGameObjectID in_gameObjectID
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
void FWwiseSoundEngineAPI_2025_1::CancelEventCallback(
	AkPlayingID in_playingID
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2025_1::GetSourcePlayPosition(
	AkPlayingID		in_PlayingID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::GetSourcePlayPositions(
	AkPlayingID		in_PlayingID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::GetPlayingSegmentInfo(
	AkPlayingID		in_PlayingID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::GetSourceStreamBuffering(
	AkPlayingID		in_PlayingID,
...
void FWwiseSoundEngineAPI_2025_1::StopAll(
	AkGameObjectID in_gameObjectID
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
void FWwiseSoundEngineAPI_2025_1::StopPlayingID(
	AkPlayingID in_playingID,
	AkTimeMs in_uTransitionDuration,
	AkCurveInterpolation in_eFadeCurve
)
...
void FWwiseSoundEngineAPI_2025_1::ExecuteActionOnPlayingID(
	AkActionOnEventType in_ActionType,
	AkPlayingID in_playingID,
	AkTimeMs in_uTransitionDuration,
	AkCurveInterpolation in_eFadeCurve
...
void FWwiseSoundEngineAPI_2025_1::SetRandomSeed(
	AkUInt32 in_uSeed
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
void FWwiseSoundEngineAPI_2025_1::MuteBackgroundMusic(
	bool in_bMute
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
bool FWwiseSoundEngineAPI_2025_1::GetBackgroundMusicMute()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::SoundEngine::GetBackgroundMusicMute();
}

AKRESULT FWwiseSoundEngineAPI_2025_1::SendPluginCustomGameData(
	AkUniqueID in_busID,
	AkGameObjectID in_gameObjectID,
	AkPluginType in_eType,
...
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::SoundEngine::SendPluginCustomGameData(in_busID, in_gameObjectID, in_eType, in_uCompanyID, in_uPluginID, in_pData, in_uSizeInBytes);
}

AKRESULT FWwiseSoundEngineAPI_2025_1::RegisterGameObj(
	AkGameObjectID in_gameObjectID
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2025_1::UnregisterGameObj(
	AkGameObjectID in_gameObjectID
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2025_1::UnregisterAllGameObj(
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetPosition(
	AkGameObjectID in_GameObjectID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetMultiplePositions(
	AkGameObjectID in_GameObjectID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetScalingFactor(
	AkGameObjectID in_GameObjectID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetDistanceProbe(
...
void FWwiseSoundEngineAPI_2025_1::ProcessBanks()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	AK::SoundEngine::ProcessBanks();
}

AKRESULT FWwiseSoundEngineAPI_2025_1::ClearBanks()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::SoundEngine::ClearBanks();
}

AKRESULT FWwiseSoundEngineAPI_2025_1::SetBankLoadIOSettings(
...
#ifdef AK_SUPPORT_WCHAR
AKRESULT FWwiseSoundEngineAPI_2025_1::LoadBank(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::LoadBankMemoryView(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::LoadBankMemoryCopy(
	const void* in_pInMemoryBankPtr,
	AkUInt32 in_uInMemoryBankSize,
	AkBankID& out_bankID)
{
...
AKRESULT FWwiseSoundEngineAPI_2025_1::DecodeBank(
	const void* in_pInMemoryBankPtr,
	AkUInt32			in_uInMemoryBankSize,
...
#ifdef AK_SUPPORT_WCHAR
AKRESULT FWwiseSoundEngineAPI_2025_1::UnloadBank(
	const wchar_t* in_pszString,
	const void* in_pInMemoryBankPtr,
	AkBankType			in_bankType
)
...
void FWwiseSoundEngineAPI_2025_1::CancelBankCallbackCookie(
	void* in_pCookie
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
#ifdef AK_SUPPORT_WCHAR
AKRESULT FWwiseSoundEngineAPI_2025_1::PrepareBank(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::ClearPreparedEvents()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
#ifdef AK_SUPPORT_WCHAR
AKRESULT FWwiseSoundEngineAPI_2025_1::PrepareEvent(
	AK::SoundEngine::PreparationType		in_PreparationType,
...
#ifdef AK_SUPPORT_WCHAR
AKRESULT FWwiseSoundEngineAPI_2025_1::PrepareBus(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetMedia(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::TryUnsetMedia(
	AkSourceSettings* in_pSourceSettings,
	AkUInt32          in_uNumSourceSettings,
...
#ifdef AK_SUPPORT_WCHAR
AKRESULT FWwiseSoundEngineAPI_2025_1::PrepareGameSyncs(
	AK::SoundEngine::PreparationType	in_PreparationType,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetListeners(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::AddListener(
	AkGameObjectID in_emitterGameObj,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::RemoveListener(
	AkGameObjectID in_emitterGameObj,
	AkGameObjectID in_listenerGameObj
)
{
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetDefaultListeners(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::AddDefaultListener(
	AkGameObjectID in_listenerGameObj
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2025_1::RemoveDefaultListener(
	AkGameObjectID in_listenerGameObj
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2025_1::ResetListenersToDefault(
	AkGameObjectID in_emitterGameObj
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetListenerSpatialization(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetRTPCValue(
	AkRtpcID in_rtpcID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetRTPCValueByPlayingID(
	AkRtpcID in_rtpcID,
	AkRtpcValue in_value,
	AkPlayingID in_playingID,
	AkTimeMs in_uValueChangeDuration,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::ResetRTPCValue(
	AkRtpcID in_rtpcID,
	AkGameObjectID in_gameObjectID,
	AkTimeMs in_uValueChangeDuration,
	AkCurveInterpolation in_eFadeCurve,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::ResetRTPCValueByPlayingID(
	AkRtpcID in_rtpcID,
	AkPlayingID in_playingID,
	AkTimeMs in_uValueChangeDuration,
	AkCurveInterpolation in_eFadeCurve,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetSwitch(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::PostTrigger(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetState(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetGameObjectAuxSendValues(
	AkGameObjectID		in_gameObjectID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::RegisterBusVolumeCallback(
	AkUniqueID in_busID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::RegisterBusMeteringCallback(
	AkUniqueID in_busID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::RegisterOutputDeviceMeteringCallback(
	AkOutputDeviceID in_idOutput,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetGameObjectOutputBusVolume(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetContainerEffect(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetActorMixerEffect(
	AkUniqueID in_audioNodeID,
	AkUInt32 in_uFXIndex,
	AkUniqueID in_shareSetID
)
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetBusEffect(
	AkUniqueID in_audioNodeID,
	AkUInt32 in_uFXIndex,
	AkUniqueID in_shareSetID
)
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetOutputDeviceEffect(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetBusConfig(
	AkUniqueID in_audioNodeID,
	AkChannelConfig in_channelConfig
)
{
...
AKRESULT FWwiseSoundEngineAPI_2025_1::ResetBusConfig(
	AkUniqueID in_audioNodeID
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetSidechainMixConfig(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetObjectObstructionAndOcclusion(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetMultipleObstructionAndOcclusion(
	AkGameObjectID in_EmitterID,
	AkGameObjectID in_uListenerID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::GetContainerHistory(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetContainerHistory(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::StartOutputCapture(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::StopOutputCapture()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::SoundEngine::StopOutputCapture();
}

AKRESULT FWwiseSoundEngineAPI_2025_1::AddOutputCaptureMarker(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::AddOutputCaptureBinaryMarker(
	void* in_pMarkerData,
...
AkUInt32 FWwiseSoundEngineAPI_2025_1::GetSampleRate()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::SoundEngine::GetSampleRate();
}

AKRESULT FWwiseSoundEngineAPI_2025_1::RegisterCaptureCallback(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::UnregisterCaptureCallback(
	AkCaptureCallbackFunc in_pfnCallback,
	AkOutputDeviceID in_idOutput,
	void* in_pCookie
)
...
AKRESULT FWwiseSoundEngineAPI_2025_1::StartProfilerCapture(
	const AkOSChar* in_CaptureFileName
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2025_1::StopProfilerCapture()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::SoundEngine::StopProfilerCapture();
}

AKRESULT FWwiseSoundEngineAPI_2025_1::SetOfflineRenderingFrameTime(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetOfflineRendering(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::AddOutput(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::RemoveOutput(
	AkOutputDeviceID in_idOutput
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2025_1::ReplaceOutput(
	const AkOutputSettings& in_Settings,
	AkOutputDeviceID in_outputDeviceId,
...
AkOutputDeviceID FWwiseSoundEngineAPI_2025_1::GetOutputID(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetBusDevice(
	AkUniqueID in_idBus,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::GetDeviceList(
	AkUInt32 in_ulCompanyID,
	AkUInt32 in_ulPluginID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::SetOutputVolume(
	AkOutputDeviceID in_idOutput,
	AkReal32 in_fVolume
)
{
...
AKRESULT FWwiseSoundEngineAPI_2025_1::GetDeviceSpatialAudioSupport(
	AkUInt32 in_idDevice)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2025_1::Suspend(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::WakeupFromSuspend(
...
AkUInt32 FWwiseSoundEngineAPI_2025_1::GetBufferTick()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::SoundEngine::GetBufferTick();
}

AkUInt64 FWwiseSoundEngineAPI_2025_1::GetSampleTick()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::SoundEngine::GetSampleTick();
}

AKRESULT FWwiseSoundEngineAPI_2025_1::ResetGlobalValues()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::SoundEngine::ResetGlobalValues();
}

AKRESULT FWwiseSoundEngineAPI_2025_1::SetAssertHook(AkAssertHook in_pfnAssertHook)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::SoundEngine::SetAssertHook(in_pfnAssertHook);
}

AKRESULT FWwiseSoundEngineAPI_2025_1::FQuery::GetPosition(
	AkGameObjectID in_GameObjectID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FQuery::GetListeners(
	AkGameObjectID in_GameObjectID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FQuery::GetListenerPosition(
	AkGameObjectID in_uListenerID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FQuery::GetListenerSpatialization(
	AkGameObjectID in_uListenerID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FQuery::GetRTPCValue(
	AkRtpcID in_rtpcID,
	AkGameObjectID in_gameObjectID,
	AkPlayingID	in_playingID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FQuery::GetSwitch(
	AkSwitchGroupID in_switchGroup,
	AkGameObjectID  in_gameObjectID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FQuery::GetState(
	AkStateGroupID in_stateGroup,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FQuery::GetGameObjectAuxSendValues(
	AkGameObjectID		in_gameObjectID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FQuery::GetGameObjectDryLevelValue(
	AkGameObjectID		in_EmitterID,
	AkGameObjectID		in_ListenerID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FQuery::GetObjectObstructionAndOcclusion(
	AkGameObjectID in_EmitterID,
	AkGameObjectID in_ListenerID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FQuery::QueryAudioObjectIDs(
	AkUniqueID in_eventID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FQuery::GetPositioningInfo(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FQuery::GetActiveGameObjects(
...
bool FWwiseSoundEngineAPI_2025_1::FQuery::GetIsGameObjectActive(
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FQuery::GetMaxRadius(
...
AkReal32 FWwiseSoundEngineAPI_2025_1::FQuery::GetMaxRadius(
	AkGameObjectID in_GameObjId
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AkUniqueID FWwiseSoundEngineAPI_2025_1::FQuery::GetEventIDFromPlayingID(
	AkPlayingID in_playingID
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AkGameObjectID FWwiseSoundEngineAPI_2025_1::FQuery::GetGameObjectFromPlayingID(
	AkPlayingID in_playingID
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FQuery::GetPlayingIDsFromGameObject(
	AkGameObjectID in_GameObjId,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FQuery::GetCustomPropertyValue(
	AkUniqueID in_ObjectID,
	AkUInt32 in_uPropID,
	AkInt32& out_iValue
)
...
void FWwiseSoundEngineAPI_2025_1::FAudioInputPlugin::SetAudioInputCallbacks(
...
AkUniqueID FWwiseSoundEngineAPI_2025_1::FDynamicDialogue::ResolveDialogueEvent(
		AkUniqueID			in_eventID,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FDynamicDialogue::GetDialogueEventCustomPropertyValue(
	AkUniqueID in_eventID,
	AkUInt32 in_uPropID,
	AkInt32& out_iValue
	)
...
void FWwiseSoundEngineAPI_2025_1::FDynamicSequence::FPlaylist::Enqueue(
		AkUniqueID in_audioNodeID,
		AkTimeMs in_msDelay,
		void * in_pCustomInfo,
		AkUInt32 in_cExternals,
...
void FWwiseSoundEngineAPI_2025_1::FDynamicSequence::FPlaylist::RemoveAll(int Reserve)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	Playlist.RemoveAll();
...
AK::SoundEngine::DynamicSequence::PlaylistItem* FWwiseSoundEngineAPI_2025_1::FDynamicSequence::FPlaylist::Insert(unsigned int in_uIndex)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return Playlist.Insert(in_uIndex);
}

void FWwiseSoundEngineAPI_2025_1::FDynamicSequence::FPlaylist::Erase(unsigned int in_uIndex)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	Playlist.Erase(in_uIndex);
}

AK::SoundEngine::DynamicSequence::PlaylistItem& FWwiseSoundEngineAPI_2025_1::FDynamicSequence::FPlaylist::operator[](unsigned int uiIndex) const
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return Playlist[uiIndex];
}

bool FWwiseSoundEngineAPI_2025_1::FDynamicSequence::FPlaylist::IsEmpty() const
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return Playlist.IsEmpty();
}

uint32 FWwiseSoundEngineAPI_2025_1::FDynamicSequence::FPlaylist::Length() const
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return Playlist.Length();
}

AkPlayingID FWwiseSoundEngineAPI_2025_1::FDynamicSequence::Open(
	AkGameObjectID		in_gameObjectID,
	AkUInt32			in_uFlags,
	AkCallbackFunc		in_pfnCallback,
	void* 				in_pCookie,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FDynamicSequence::Close(
	AkPlayingID in_playingID
	)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FDynamicSequence::Play( 
	AkPlayingID in_playingID,
	AkTimeMs in_uTransitionDuration,
	AkCurveInterpolation in_eFadeCurve
	)
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FDynamicSequence::Pause( 
	AkPlayingID in_playingID,
	AkTimeMs in_uTransitionDuration,
	AkCurveInterpolation in_eFadeCurve
	)
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FDynamicSequence::Resume(
	AkPlayingID in_playingID,
	AkTimeMs in_uTransitionDuration,
	AkCurveInterpolation in_eFadeCurve
	)
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FDynamicSequence::Stop(
	AkPlayingID in_playingID,
	AkTimeMs in_uTransitionDuration,
	AkCurveInterpolation in_eFadeCurve
	)
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FDynamicSequence::Break(
	AkPlayingID in_playingID
	)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FDynamicSequence::Seek(
	AkPlayingID in_playingID,
	AkTimeMs in_iPosition,
	bool in_bSeekToNearestMarker
	)
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FDynamicSequence::GetPauseTimes(
	AkPlayingID in_playingID,
	AkUInt32 &out_uTime,
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FDynamicSequence::GetPlayingItem(
	AkPlayingID in_playingID,
...
FWwiseSoundEngineAPI_2025_1::FDynamicSequence::IPlaylist* FWwiseSoundEngineAPI_2025_1::FDynamicSequence::LockPlaylist(
	AkPlayingID in_playingID
	)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSoundEngineAPI_2025_1::FDynamicSequence::UnlockPlaylist(
...
FWwiseSoundEngineAPI_2025_1::FErrorTranslator::FErrorTranslator(FGetInfoErrorMessageTranslatorFunction InMessageTranslatorFunction) :
	GetInfoErrorMessageTranslatorFunction(InMessageTranslatorFunction)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
}

bool FWwiseSoundEngineAPI_2025_1::FErrorTranslator::GetInfo(TagInformation* in_pTagList, AkUInt32 in_uCount,
...
AkErrorMessageTranslator* FWwiseSoundEngineAPI_2025_1::NewErrorMessageTranslator(FGetInfoErrorMessageTranslatorFunction InMessageTranslatorFunction)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
#if WITH_EDITORONLY_DATA
