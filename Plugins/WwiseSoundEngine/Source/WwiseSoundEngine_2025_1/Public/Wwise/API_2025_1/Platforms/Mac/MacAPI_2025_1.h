...
class FWwisePlatformAPI_2025_1_Mac : public IWwisePlatformAPI
{
public:
	UE_NONCOPYABLE(FWwisePlatformAPI_2025_1_Mac);
	FWwisePlatformAPI_2025_1_Mac() = default;
	virtual ~FWwisePlatformAPI_2025_1_Mac() override {}
...
using FWwisePlatformAPI = FWwisePlatformAPI_2025_1_Mac;
