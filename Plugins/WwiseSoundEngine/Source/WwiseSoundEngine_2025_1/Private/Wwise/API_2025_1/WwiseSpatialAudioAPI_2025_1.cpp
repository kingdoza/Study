...
FWwiseSpatialAudioAPI_2025_1::FWwiseSpatialAudioAPI_2025_1() :
	IWwiseSpatialAudioAPI(new FReverbEstimation)
{}

AKRESULT FWwiseSpatialAudioAPI_2025_1::Init(const AkSpatialAudioInitSettings& in_initSettings)
{
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::RegisterListener(
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::UnregisterListener(
	AkGameObjectID in_gameObjectID
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::SetGameObjectRadius(
	AkGameObjectID in_gameObjectID,
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::SetImageSource(
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::RemoveImageSource(
	AkImageSourceID in_srcID,
	AkUniqueID in_AuxBusID,
	AkGameObjectID in_gameObjectID
)
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::ClearImageSources(
	AkUniqueID in_AuxBusID,
	AkGameObjectID in_gameObjectID
)
{
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::SetGeometry(
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::RemoveGeometry(
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::SetGeometryInstance(
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::RemoveGeometryInstance(
	AkGeometryInstanceID in_GeometryInstanceID
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::QueryReflectionPaths(
	AkGameObjectID in_gameObjectID,
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::SetRoom(
	AkRoomID in_RoomID,
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::RemoveRoom(
	AkRoomID in_RoomID
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::SetPortal(
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::RemovePortal(
	AkPortalID in_PortalID
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::SetReverbZone(
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::RemoveReverbZone(
	AkRoomID in_ReverbZone
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::SetGameObjectInRoom(
	AkGameObjectID in_gameObjectID,
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::UnsetGameObjectInRoom(
	AkGameObjectID in_gameObjectID
)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::SetAdjacentRoomBleed(
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::SetReflectionsOrder(
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::SetDiffractionOrder(
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::SetMaxGlobalReflectionPaths(
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::SetMaxDiffractionPaths(
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::SetMaxEmitterRoomAuxSends(
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::SetNumberOfPrimaryRays(
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::SetLoadBalancingSpread(
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::SetSmoothingConstant(
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::SetEarlyReflectionsAuxSend(
	AkGameObjectID in_gameObjectID,
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::SetEarlyReflectionsVolume(
	AkGameObjectID in_gameObjectID,
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::SetPortalObstructionAndOcclusion(
	AkPortalID in_PortalID,
...
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::SpatialAudio::SetPortalObstructionAndOcclusion(in_PortalID, in_fObstruction, in_fOcclusion, in_bTransition);
}

AKRESULT FWwiseSpatialAudioAPI_2025_1::SetGameObjectToPortalObstruction(
	AkGameObjectID in_gameObjectID,
	AkPortalID in_PortalID,
	AkReal32 in_fObstruction
)
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::SetPortalToPortalObstruction(
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::QueryWetDiffraction(
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::QueryDiffractionPaths(
	AkGameObjectID in_gameObjectID,
	AkUInt32 in_positionIndex,
	AkVector64& out_listenerPos,
	AkVector64& out_emitterPos,
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::SetTransmissionOperation(
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::ResetStochasticEngine()
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::SpatialAudio::ResetStochasticEngine();
}

float FWwiseSpatialAudioAPI_2025_1::FReverbEstimation::CalculateSlope(const AkAcousticTexture& texture)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	return AK::SpatialAudio::ReverbEstimation::CalculateSlope(texture);
}

void FWwiseSpatialAudioAPI_2025_1::FReverbEstimation::GetAverageAbsorptionValues(AkAcousticTexture* in_textures, float* in_surfaceAreas, int in_numTextures, AkAcousticTexture& out_average)
{
	SCOPE_CYCLE_COUNTER(STAT_WwiseSoundEngineAPI);
	AK::SpatialAudio::ReverbEstimation::GetAverageAbsorptionValues(in_textures, in_surfaceAreas, in_numTextures, out_average);
}

AKRESULT FWwiseSpatialAudioAPI_2025_1::FReverbEstimation::EstimateT60Decay(
...
AKRESULT FWwiseSpatialAudioAPI_2025_1::FReverbEstimation::EstimateTimeToFirstReflection(
...
AkReal32 FWwiseSpatialAudioAPI_2025_1::FReverbEstimation::EstimateHFDamping(
