...
void SGenerateSoundBanks::Construct(const FArguments& InArgs)
{
	...
	{
		FMessageDialog::Open(EAppMsgType::Ok, NSLOCTEXT("AkAudio", "Warning_Ak_PlatformSupported", "Unable to generate Sound Data. Select a supported Wwise platform in the 'Project Settings > Project > Supported Platforms' dialog."));
		return;
	}
