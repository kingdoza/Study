...
class WWISESOUNDENGINE_API FWwiseSpatialAudioAPI_2025_1 : public IWwiseSpatialAudioAPI
{
public:
	UE_NONCOPYABLE(FWwiseSpatialAudioAPI_2025_1);
	FWwiseSpatialAudioAPI_2025_1();
