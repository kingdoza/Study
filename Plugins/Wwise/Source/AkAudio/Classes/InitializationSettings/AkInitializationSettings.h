...
#include "Wwise/WwiseInitSettings.h"
...
struct FAkInitializationStructure
{
	...
	WwiseInitSettings InitSettings;
...
struct FAkSpatialAudioSettings
{
	...
	UPROPERTY(EditAnywhere, Category = "Ak Initialization Settings|Spatial Audio Settings", meta = (ToolTip = "The number of primary rays used in the ray tracing engine. A larger value increases the chances of finding reflection and diffraction paths but results in higher CPU usage. The default value is 35.", ClampMin = "0"))
	...
	UPROPERTY(EditAnywhere, Category = "Ak Initialization Settings|Spatial Audio Settings", meta = (DisplayName = "CPU Limit Percentage", ToolTip = "Defines the targeted max computation time allocated for Spatial Audio as a percentage [0, 100] of the current audio frame. When the value is not 0, Spatial Audio dynamically adapts the load balancing spread. The default value is 0.", ClampMin = "0", ClampMax = "100"))
	...
	UPROPERTY(EditAnywhere, Category = "Ak Initialization Settings|Spatial Audio Settings", meta = (
	...
	UPROPERTY(EditAnywhere, Category = "Ak Initialization Settings|Spatial Audio Settings", meta = (DisplayName = "Clustering Minimum Points [Experimental]", ToolTip = "Minimum number of emitters in a cluster. Default value is 0. Values less than 2 disable the clustering.", ClampMin = "0"))
	uint32 ClusteringMinPoints = 0;

	UPROPERTY(EditAnywhere, Category = "Ak Initialization Settings|Spatial Audio Settings", meta = (ToolTip = "Max distance between emitters to be considered as neighbors. This distance is specified for the reference distance defined by fClusteringDeadZoneDistance. Default value is 500.0.", ClampMin = "0"))
	float ClusteringMaxDistance = 500.0f;

	UPROPERTY(EditAnywhere, Category = "Ak Initialization Settings|Spatial Audio Settings", meta = (ToolTip = "Defines a dead zone around the listener where no emitters are clusters. Default value is 1000.0.", ClampMin = "1.0"))
	float ClusteringDeadZoneDistance = 1000.0f;
